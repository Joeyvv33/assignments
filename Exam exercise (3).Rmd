...
Name: Joey van Vlimmeren, snr: 2003964
...
graph2 <- filter(oecd, Country %in% c('Chile', 'Spain', 'Australia', 'Mexico', 'Netherlands'))%>%
...
eff.bar <- ggplot(eff, aes(x = reorder(Country,Score), y = Score, fill= Country)) +
        ...
        guides(fill=FALSE) +
        xlab("Country") +
        ylab("Efficiency scores according to Joey van Vlimmeren ")
